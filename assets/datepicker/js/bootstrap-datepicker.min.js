  ...
  var j = (function () {
    ...
    k = function (b, c) {
      a.data(b, "datepicker", this),
        ...
        (this.component =
          !!this.element.hasClass("date") && this.element.find(".add-on, .input-group-addon, .input-group-append, .input-group-prepend, .btn")),
      ...
      if (!isNaN(h) && !isNaN(i)) {
        ...
        for (var x, y, z = []; u.valueOf() < w; ) {
          ...
          this.o.beforeShowDay !== a.noop &&
            ...
            z.push(
              '<td class="' + y.join(" ") + '"' + (e ? ' title="' + e + '"' : "") + ' data-date="' + u.getTime().toString() + '">' + E + "</td>"
            ),
            (e = null),
